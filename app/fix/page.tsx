...
export default function FixPage() {
  ...
  // Non-2024/25 users go straight to taxfix — no intermediate screen needed
  useEffect(() => {
    if (ready && taxYear !== "2024/25") {
      window.location.href = TAXFIX_URL;
    }
  }, [ready, taxYear]);

  // Render nothing while we decide (or redirect)
  if (!ready || taxYear !== "2024/25") return null;
